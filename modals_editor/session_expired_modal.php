...
<div id="sessionExpiredOverlay" class="modal-overlay" data-size="sm" data-backdrop-close="false" data-esc-close="false">
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-body">
            <p class="modal-text" style="font-size: 13px; line-height: 1.5; margin-bottom: 16px;">
            ...
            <div class="modal-form-group" style="margin-bottom: 0;">
                <input type="password" id="sessionExpiredPassword" class="modal-input" placeholder="Введите ваш пароль" onkeydown="if(event.key === 'Enter') submitSessionReauth()">
        ...
        <div class="modal-footer">
            <button type="button" onclick="cancelSessionReauth()" class="modal-btn modal-btn-ghost">Сбросить изменения</button>
            <button type="button" onclick="submitSessionReauth()" class="modal-btn modal-btn-primary">Войти</button>
        </div>
    </div>
</div>
