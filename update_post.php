...
<body>
    ...
    <h1>$title</h1>
    <div class="date">📅 $date (отредактировано)</div>
...
// Применяем настройки фона и подложки из post_backgrounds.json
require_once 'background_functions.php';
$bgSettings = getPostBackground($postId);
if ($bgSettings) {
    applyBackgroundToHtml($filename, $bgSettings);
}
